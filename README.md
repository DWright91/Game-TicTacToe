...
1a. Server: The server you create is to be a concurrent server. After the
...
1b. Client: The client is responsible for all communication with the human
...
1c. Shared code: Create a C/C++-module that contains any common
...
1d. System call usage: Use each system call in an appropriate manner; read
